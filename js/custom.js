...
(function ($) {
  ...
  jQuery(".orange-bg").on("click", function () {
    jQuery(".logo-header img").attr("src", "images/orange.png");
    jQuery(".footer-logo .text-center img").attr("src", "images/orange.png");
    return false;
  });

  jQuery(".strong-blue-bg").on("click", function () {
    jQuery(".logo-header img").attr("src", "images/blue.png");
    jQuery(".footer-logo .text-center img").attr("src", "images/blue.png");
    return false;
  });

  jQuery(".moderate-green-bg").on("click", function () {
    jQuery(".logo-header img").attr("src", "images/purple.png");
    jQuery(".footer-logo .text-center img").attr("src", "images/purple.png");
    return false;
  });

  jQuery(".vivid-yellow-bg").on("click", function () {
    jQuery(".logo-header img").attr("src", "images/yellow.png");
    jQuery(".footer-logo .text-center img").attr("src", "images/yellow.png");
    return false;
  });
